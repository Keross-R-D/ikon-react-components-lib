...
function CropperFormComponent({ onNewFileUpload }: Props) {
  ...
  const getImagePreview = (state: ActiveState) => {
    const imgSource =
      croppedImage && activeState === state
        ? croppedImage
        : aspectRatioWiseImages[state];
    return (
      <>
            ...
            <div className="flex flex-col lg:flex-row gap-3 justify-between">
              <div>
                <ToggleGroup
                  ...
                  value={activeState}
                  onValueChange={(value) =>
                    setActiveState(value as ActiveState)
                  }
                >
              ...
              <div className="flex flex-col lg:flex-row gap-3 justify-between">
                ...
                <ToggleGroup type="single" variant="outline" value="">
                  <ToggleGroupItem
                    ...
                    value="up"
                    onClick={() => setMoveDirection({ x: 0, y: -5 })}
                  >
                    <ArrowUp />
                  </ToggleGroupItem>
                  <ToggleGroupItem
                  ...
                  <ToggleGroupItem
                    className="rounded-none border-e-0"
                    value="left"
                    onClick={() => setMoveDirection({ x: -5, y: 0 })}
                  >
                    <ArrowLeft />
                  </ToggleGroupItem>
                  <ToggleGroupItem
                ...
                <ToggleGroup
                  ...
                  value=""
                  onValueChange={(value) =>
                    setScale((pre) => pre + parseFloat(value))
                  }
                >

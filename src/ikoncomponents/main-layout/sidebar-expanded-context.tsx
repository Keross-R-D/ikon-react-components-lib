 ...
 * that siblings of the rail (app sidebar, header, content) can shift to make
 * room for the expanded panel instead of being covered by it.
 */
...
/** Convenience hook returning just the boolean (used by rail items). */
